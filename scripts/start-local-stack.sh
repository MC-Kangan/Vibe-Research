...
if [[ -z "$TRADE_RESEARCH_FUNDAMENTAL_PROVIDER" && -n "${VR_SEC_USER_AGENT:-}" ]]; then
...
(
  ...
  TRADE_RESEARCH_DATA_ROOT="${VIBE_LOCAL_DATA_DIR}/trade-research" \
